...
for dirname, dirnames, filenames in sorted(os.walk('.')):
		...
		for filename in sorted(filenames):
			...
			if filename.endswith("-doz.txt") or filename.endswith("-zup.txt") or filename.endswith("-kot.txt")  or filename.endswith("-gedz.txt") or filename.endswith("-tra.txt"):
				...
				tout=re.sub(u"̣",u"",tout,0,re.U|re.MULTILINE)  # Combining Dot Below (U+0323) (suppress)
				tout=re.sub(u"ɑ",u"a",tout,0,re.U|re.MULTILINE) # Latin Small Letter Alpha (U+0251)
				tout=re.sub(u"ɒ",u"a",tout,0,re.U|re.MULTILINE) # Latin Small Letter Turned Alpha (U+0252)
				tout=re.sub(u"а",u"a",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter A (U+0430)
				tout=re.sub(u"А",u"A",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter A (U+0410)
				tout=re.sub(u"Α",u"A",tout,0,re.U|re.MULTILINE) # Greek Capital Letter Alpha (U+0391)
				tout=re.sub(u"В",u"B",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Ve (U+0412)
				tout=re.sub(u"с",u"c",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Es (U+0441)
				tout=re.sub(u"С",u"C",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Es (U+0421)
				tout=re.sub(u"е",u"e",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Ie (U+0435)
				tout=re.sub(u"Е",u"E",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Ie (U+0415)
				tout=re.sub(u"Ε",u"E",tout,0,re.U|re.MULTILINE) # Greek Capital Letter Epsilon (U+0395)
				tout=re.sub(u"ɒ",u"ɛ",tout,0,re.U|re.MULTILINE) # Latin Small Letter Turned Alpha (U+0252)
				tout=re.sub(u"ə",u"ɛ",tout,0,re.U|re.MULTILINE) # Latin Small Letter Schwa (U+0259)  (ɛ ou a ?)
				#tout=re.sub(u"ɣ",u"g",tout,0,re.U|re.MULTILINE) # Latin Small Letter Gamma (U+0263) - mais citations en tamashek ???		
				tout=re.sub(u"Н",u"H",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter En (U+041D)
				tout=re.sub(u"í",u"i",tout,0,re.U|re.MULTILINE) # Latin Small Letter I With Acute (U+00ED)
				tout=re.sub(u"ı",u"i",tout,0,re.U|re.MULTILINE) # Latin Small Letter Dotless I (U+0131)
				tout=re.sub(u"ɩ",u"i",tout,0,re.U|re.MULTILINE) # Latin Small Letter Iota (U+0269)
				#tout=re.sub(ur"\|",u"l",tout,0,re.U|re.MULTILINE)
				tout=re.sub(u"к",u"k",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Ka (U+043A)
				tout=re.sub(u"Κ",u"k",tout,0,re.U|re.MULTILINE) # Greek Capital Letter Kappa (U+039A)
				tout=re.sub(u"т",u"m",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Te (U+0442)
				tout=re.sub(u"М",u"M",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Em (U+041C)
				tout=re.sub(u"Μ",u"M",tout,0,re.U|re.MULTILINE) # Greek Capital Letter Mu (U+039C)
				tout=re.sub(u"Ν",u"N",tout,0,re.U|re.MULTILINE) # Greek Capital Letter Nu (U+039D)
				tout=re.sub(u"п",u"n",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Pe (U+043F)
				tout=re.sub(u"щ",u"o",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Shcha (U+0449)
				tout=re.sub(u"ш",u"m",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Sha (U+0448)
				tout=re.sub(u"о",u"o",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter O (U+043E)
				tout=re.sub(u"ο",u"o",tout,0,re.U|re.MULTILINE) # Greek Small Letter Omicron (U+03BF)
				tout=re.sub(u"ὸ",u"o",tout,0,re.U|re.MULTILINE) # Greek Small Letter Omicron With Varia (U+1F78)
				tout=re.sub(u"О",u"O",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter O (U+041E)
				tout=re.sub(u"Р",u"P",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Er (U+0420)
				tout=re.sub(u"р",u"p",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Er (U+0440)
				tout=re.sub(u"г",u"r",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Ghe (U+0433)
				tout=re.sub(u"ɾ",u"r",tout,0,re.U|re.MULTILINE) # Latin Small Letter R With Fishhook (U+027E)
				tout=re.sub(u"Т",u"T",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Te (U+0422)
				tout=re.sub(u"и",u"u",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter I (U+0438)
				tout=re.sub(u"ц",u"u",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter Tse (U+0446)
				tout=re.sub(u"у",u"y",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter U (U+0443)
				tout=re.sub(u"ɪ",u"y",tout,0,re.U|re.MULTILINE) # Latin Letter Small Capital I (U+026A)
				tout=re.sub(u"л",u"ɲ",tout,0,re.U|re.MULTILINE) # Cyrillic Small Letter El (U+043B)
				tout=re.sub(u"Л",u"Ɲ",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter El (U+041B)
				tout=re.sub(u"á",u"a",tout,0,re.U|re.MULTILINE) # Latin Small Letter A With Acute (U+00E1)
				tout=re.sub(u"ý",u"y",tout,0,re.U|re.MULTILINE) # Latin Small Letter Y With Acute (U+00FD)
				tout=re.sub(u"ú",u"u",tout,0,re.U|re.MULTILINE) # Latin Small Letter U With Acute (U+00FA)
				tout=re.sub(u"№",u"N°",tout,0,re.U|re.MULTILINE)
				tout=re.sub(u"ï",u"i",tout,0,re.U|re.MULTILINE) # Latin Small Letter I With Diaeresis (U+00EF)
				tout=re.sub(u"˚",u"°",tout,0,re.U|re.MULTILINE) # Ring Above (U+02DA)
				tout=re.sub(u"З",u"3",tout,0,re.U|re.MULTILINE) # Cyrillic Capital Letter Ze (U+0417)
				tout=re.sub(u"j̀",u"j",tout,0,re.U|re.MULTILINE) # j + Combining Grave Accent
				tout=re.sub(u"∫",u"ʃ",tout,0,re.U|re.MULTILINE) # Integral (U+222B) -> Latin Small Letter Esh (U+0283)
				tout=re.sub(u"ƒ",u"ʃ",tout,0,re.U|re.MULTILINE) # Latin Small Letter F With Hook (U+0192) -> Latin Small Letter Esh (U+0283) (jama)
				tout=re.sub(u"ε",u"ɛ",tout,0,re.U|re.MULTILINE) # Greek Small Letter Epsilon (U+03B5)
				tout=re.sub(u"≈",u"ɲ",tout,0,re.U|re.MULTILINE) # Almost Equal To (U+2248) - tarawele-sumanikelanw-zup
				tout=re.sub(u"ʋ",u"u",tout,0,re.U|re.MULTILINE) # Latin Small Letter V With Hook (U+028B)
				tout=re.sub(u"ↄ",u"ɔ",tout,0,re.U|re.MULTILINE) # Latin Small Letter Reversed C (U+2184)
